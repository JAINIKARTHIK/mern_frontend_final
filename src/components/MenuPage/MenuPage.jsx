...
const MenuPage = () => {
  ...
  useEffect(() => {
   // Axios.get('http://localhost:3000/resdetails')
    Axios.get('https://food-del-ser.onrender.com/resdetails')
      .then((res) => {
...
const handleOpenRazorpay = (data) => {
        ...
        const options = {
            ...
            handler: function (response) {
                ...
                // Axios.post('http://localhost:3000/verify', { response: response })
                 Axios.post('https://food-del-ser.onrender.com/verify', { response: response })
                    .then(res => {
                        console.log(res, "37")
    ...
    const handlePayment = (amount) => {
      ...
      Axios.post('https://food-del-ser.onrender.com/orders', _data)
            .then(res => {
